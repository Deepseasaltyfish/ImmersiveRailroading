...
public class RailInfo {
	...
	public static class TagMapper implements cam72cam.mod.serialization.TagMapper<RailInfo> {
		...
		private static RailInfo legacy(TagCompound nbt) {
			...
			RailSettings settings = new RailSettings(gauge, "default", type, length, quarters / 4F * 90, 1, TrackPositionType.FIXED, type == TrackItems.SLOPE ? TrackSmoothing.NEITHER : TrackSmoothing.BOTH ,  0, 0, 0, 0, true, -1, null, TrackDirection.NONE, railBed, cam72cam.mod.item.ItemStack.EMPTY, false, false, 1,  1);
