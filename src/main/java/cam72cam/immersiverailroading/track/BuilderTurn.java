...
public class BuilderTurn extends BuilderCubicCurve {
    ...
    public CubicCurve getCurve() {
        ...
        curve = new CubicCurve(curve.p1, curve.ctrl1, curve.ctrl2.add(0, height, 0), curve.p2.add(0, height, 0), 0, 1).linearize(info.settings.smoothing, info.settings.pitchStart, info.settings.pitchEnd);
        return curve;
    }
}
