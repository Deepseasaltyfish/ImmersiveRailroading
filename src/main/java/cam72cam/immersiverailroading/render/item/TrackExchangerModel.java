...
public class TrackExchangerModel implements ItemRender.IItemModel {
	...
	public static void render(ItemStack stack, World world, RenderState state) {
		...
		RailInfo info = new RailInfo(
                new RailSettings(data.gauge, data.track, TrackItems.STRAIGHT, 18, 0, 1, TrackPositionType.FIXED, TrackSmoothing.BOTH, 0, 0, 0,0,true, -1, null, TrackDirection.NONE, data.railBed, ItemStack.EMPTY, false, false, 1, 1),
